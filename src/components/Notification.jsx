...
const Notification = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-gray-100 dark:bg-slate-800 p-8 rounded-lg w-96">
      ...
      <div className="mt-5 ">
        {chatData?.map((item, index) => (
          <div key={index} className="flex items-center leading-8 gap-5 border-b-2 border-color p-3">
